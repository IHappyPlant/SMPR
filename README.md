...
2. После настройки силы потенциалов, объекты выборки с нулевыми потенциалами можно не использовать при классификации. Благодаря этому - высокая скорость работы. На выборке ирисов Фишера быстрее, чем все предыдущие рассмотренные алгоритмы.
...
Протестируем алгоритм на выборке ирисов Фишера. В качестве алгоритма классификации будем использовать kwNN(k = 10, q = 0.1)  
Результат работы STOLP:  
![](https://github.com/IHappyPlant/RProjects/tree/master/img/STOLP_plot.png)
