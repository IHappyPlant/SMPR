...
|-----------------------|------------------------------------------------------|-------|---------------|
| [kNN](#метод-k-ближайших-соседей-knn)                   | k = 6                                                | 0.033 | 4.95          |
| [kwNN](#метод-k-взвешенных-ближайших-соседей-kwnn)                  | k = 6, q = 0.1                                       | 0.033 | 4.95          |
| Потенциальные функции | h(setosa) = 1, h(!setosa) = 0.4, Gamma_i - случайные | -     | 5             |
